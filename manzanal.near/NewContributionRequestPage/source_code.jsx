...
const renderStepOne = () => {
  return (
    <Widget src={`${ownerId}/widget/NewContributionRequestForm`} props={{}} />
  );
};
  ...
  <>
    ...
    <Footer>
      ...
      <NextButton onClick={onPublishRequestClick}>
        <i class={`bi ${propsData[state.step].nextButtonIcon}`}></i>
        {propsData[state.step].nextButtonText}
      </NextButton>
    </Footer>
  </>
);
...
return (
  <Widget src={`${ownerId}/widget/Theme`} props={{ children: renderContent }} />
);
