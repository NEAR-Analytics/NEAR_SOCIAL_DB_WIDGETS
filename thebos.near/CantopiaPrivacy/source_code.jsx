...
This Privacy Policy describes the types of information gathered by Proximity Labs Limited (BVI) (" **Proximity**", "us" or "we") in the process of providing cantopia.pages.dev (the "Site"), how we use the information, with whom the information may be shared, what choices are available to you, and our efforts to protect the information you provide to us through the Site.
...
Under the GDPR, Proximity is what is known as a "Controller" of the Personal Data that you provide us with. We collect information from you on the Site, and we are responsible for protection of your information.

1. **What Information Does Proximity Collect?**

Like most websites delivered via the Internet, we or third-party service providers may collect non-personally identifiable or anonymous information about you that is stored in technical log files. This information may include, but is not limited to, IP addresses, traffic routing data, system configuration information, and other information about traffic to our website.
...
We may accept and gather information to provide the Site to you. If you contact us, we collect your personal information so that we can respond to your requests for information. We collect log information to help us to diagnose problems with our servers, administer the Site, calculate usage levels, and otherwise provide services to you.
...
You have the right to obtain confirmation as to whether personal data concerning you is being processed, and, where that is the case, access the personal data and all the relevant information. For any questions about the process, you may send an email to legal@proximity.dev.

1. **How Do We Retain and Protect Your Information?**
...
Please be aware that public blockchains provide transparency into transactions and Proximity is not responsible for preventing or managing information broadcasted on a blockchain.
...
1. **Children and Young People's Information.**
...
Sources of Personal Information. We gather various types of personal information from individuals who access or use our Site, from a range of sources, such as:
