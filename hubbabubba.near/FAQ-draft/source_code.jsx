return (
  <div>
    ...
    <p>
      <h4>
        <strong>What is Horizon?</strong>
      </h4>
      <br />
      <a href="https://youtu.be/Fyl1Hlo-rM0">
        <img
          src="https://s3.us-east-2.amazonaws.com/nearhorizon.assets/near-horizon-first-looksv15.gif"
          alt="horizon first looks"
        />
      </a>
    </p>
    <p>
    ...
    <br />
    <h4>
      <strong>Where do I find help?</strong>
    </h4>
    <p>
      <a href="https://near.org/nearhorizon.near/widget/Index?tab=help">
        Horizon help page
    ...
    <br />
    <h4>
      <strong>How do I find projects?</strong>
    </h4>
    <p>
    ...
    <br />
    <h4>
      <strong>Are there analytics?</strong>
    </h4>
    <p>
    ...
    <h4>
      <strong>
        I tried to create a project but the transaction didn’t go through, I got
