...
const getTokenBalance = () => {
  ...
  erc20.balanceOf(state.sender).then((rawBalance) => {
    State.update({
...
const getVote = (_signer) => {
  ...
  erc20.hasMinted(state.sender).then((_hasMinted) => {
    if (_hasMinted) {
...
return (
  <Theme>
    <div class="LidoContainer">
      <div class="Header">Claim Votes</div>
      <div class="SubHeader">
      ...
      <div
        class="LidoForm"
        style={{ paddingTop: "6px", paddingBottom: "32px" }}
      >
        {state.sender && (
          <>
      ...
      <div class="LidoStakeForm" style={{ marginTop: "-40px" }}>
        {!!state.sender ? (
          state.hasMinted ? (
            <button
