...
const Card = styled.div` height: 50px; background-color: pink; padding: 12px; margin: 8px; border-radius: 22px; box-shadow: 5px 5px 5px gray; `;
  ...
  <Card>
    ...
    <div className="d-flex flex-row h-100">
      ...
      <Body>
        {" "}
        <Content>
          <p>{data["name"]}</p> <p>{data["icon"]}</p> <p>{data["color"]}</p>
        </Content>{" "}
      </Body>{" "}
    </div>{" "}
  </Card>
