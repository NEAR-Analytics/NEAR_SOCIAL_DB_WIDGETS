...
const Card = styled.div` height: 400px; background-color: green; padding: 12px; margin: 8px; border-radius: 22px; box-shadow: 5px 5px 5px gray; border: solid gray; `;
  ...
  <Card>
    ...
    <div className="d-flex flex-row h-100">
      ...
      <Body>
        {" "}
        <Content>
          <p>{data["category"]}</p> <p>{data["subcategory"]}</p>{" "}
          <p>{data["brand"]}</p> <p>{data["description"]}</p>
        </Content>{" "}
      </Body>{" "}
    </div>{" "}
  </Card>
