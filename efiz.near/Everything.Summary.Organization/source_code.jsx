...
const Card = styled.div` height: 325px; background-color: blue; padding: 12px; margin: 8px; border-radius: 22px; box-shadow: 5px 5px 5px gray; border: solid gray; `;
  ...
  <Card>
    ...
    <div className="d-flex flex-row h-100">
      ...
      <Body>
        {" "}
        <Content>
          <p>{data["address"]}</p> <Markdown text={data["description"]} />{" "}
          <p>{data["name"]}</p>
        </Content>{" "}
      </Body>{" "}
    </div>{" "}
