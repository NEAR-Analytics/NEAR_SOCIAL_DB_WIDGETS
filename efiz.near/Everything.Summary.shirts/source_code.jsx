...
const Card = styled.div` height: 125px; background-color: pink; padding: 12px; margin: 8px; border-radius: 22px; box-shadow: 5px 5px 5px purple; border: purple; `;
  ...
  <Card>
    ...
    <div className="d-flex flex-row h-100">
      ...
      <Body>
        {" "}
        <Content>
          <p>{data["material"]}</p> <p>{data["brand"]}</p>{" "}
          <p>{data["color"]}</p> <p>{data["size"]}</p> <p>{data["sleeve"]}</p>{" "}
          <p>{data["collar"]}</p>
        </Content>{" "}
      </Body>{" "}
    </div>{" "}
