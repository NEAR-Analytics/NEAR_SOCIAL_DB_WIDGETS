...
const Card = styled.div` height: 600px; background-color: black; padding: 12px; margin: 8px; border-radius: 22px; box-shadow: 5px 5px 5px gray; border: solid gray; `;
  ...
  <Card>
    ...
    <div className="d-flex flex-row h-100">
      ...
      <Body>
        {" "}
        <Content>
          <p>{data["artist"]}</p> <p>{data["medium"]}</p> <p>{data["year"]}</p>{" "}
          <p>{data["color"]}</p>
        </Content>{" "}
      </Body>{" "}
    </div>{" "}
