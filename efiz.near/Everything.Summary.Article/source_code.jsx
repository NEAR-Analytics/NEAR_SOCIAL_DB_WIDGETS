...
const Card = styled.div` height: 220px; background-color: red; padding: 12px; margin: 8px; border-radius: 22px; box-shadow: 5px 5px 5px gray; border: solid gray; `;
  ...
  <Card>
    ...
    <div className="d-flex flex-row h-100">
      ...
      <Body>
        {" "}
        <Content>
          <p>{data["title"]}</p> <Markdown text={data["description"]} />{" "}
          <p>{data["author"]}</p>
        </Content>{" "}
      </Body>{" "}
    </div>{" "}
