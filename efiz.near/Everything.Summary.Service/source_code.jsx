...
const Card = styled.div` height: 300px; background-color: blue; padding: 12px; margin: 8px; border-radius: 22px; box-shadow: 5px 5px 5px gray; border: solid gray; `;
