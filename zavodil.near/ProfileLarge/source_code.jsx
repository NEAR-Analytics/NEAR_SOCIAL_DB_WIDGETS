...
const badges = [];
const allBadges = Social.get("*/badge/**", "final") ?? {};
Object.entries(allBadges).forEach((contractData) => {
  const contractId = contractData[0] || "";
  Object.entries(contractData[1]["badge"]).forEach((badgeData) => {
      ...
      if (holderData[0] == accountId && holderData[0] !== null) {
        ...
        let content =
          badgeInfo.linktree.website ?? null ? (
            <a
              href={badgeInfo.linktree.website}
              className={"link-dark"}
