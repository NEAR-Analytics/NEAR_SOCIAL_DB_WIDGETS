...
return (
  <>
    <div class="container min-vw-80">
      ...
      <hr />
      <img
        src="https://cdn.discordapp.com/attachments/1004449104006488066/1110170938944802887/mmc_discord_profile-image_copy.gif"
        alt="MMCGIFLOGO"
        width="195"
        height="195"
      ></img>
      ...
      ></img>
      <br></br>
      <strong>📁 NFT - Solve to Earn</strong>
      <br></br>
      <br></br>
      <h3>🕵️‍♂️---The Murder Mystery Collective</h3>
      <a href="https://playmmc.io">🔗---MMC Website</a>
      <a href="https://discord.gg/playmmc">🔗---MMC Discord</a>
      <a href="https://www.mmcmarketplace.xyz/">🔗---MMC Marketplace</a>
      ...
      <br></br>
      <br></br>
      <strong>What is The Murder Mystery Collective?</strong>
      <p>
        Our Murder Mystery events are played in Discord. The community works
        together to find clues, solve puzzles, and uncover evidence to crack the
        case. Participation in the event earns you XP, which can be used to
        redeem prizes. In our Discord, you'll see a channel to register, and a
        channel to catch yourself up on the backstory. If you haven't
        participated in the previous chapters, don't worry, we got you! This is
        a great time to jump on and help to solve the case.
      </p>
      <p>
        When the event starts, there will be starting clues provided which the
        community reveals together (reveal parties are a vibe!). Once revealed,
        other clues will surface to further investigate.
      </p>
      <p>
        After clues are revealed, the community must decide which clues should
        be combined in order to uncover evidence, puzzles, or more details in
        order to progress further in the game. (and sometimes traps!)
      </p>
      <p>
        You don't need to be a puzzle wizard or an escape room pro in order to
        participate, have fun, and earn XP in our events. Simply help the team
        make decisions, join in on revealing clues, and test your Detective
        skills at cracking the case.
      </p>
      ...
      <a href="https://discord.com/channels/1004449103012442132/1109476348524765235">
        🔷---Blue Furs Discord Channel
      </a>
      <br></br>
      <img
      ...
      <i>Within the MMC Discord you will find the Partner Project channels!</i>
      <br></br>
      <i>
        Below is a list of the partner projects in the order of the Discord
        Server.
      </i>
      <hr />
      <h3>💀---B💀NEHEDZ</h3>
      <i>
        Here they come emerge from six feet under. back from the afterlife..
        meet the B💀NEHEDZ...!!
      </i>
      <br></br>
      <img
        src="https://byzantion.mypinata.cloud/ipfs/bafybeidflrcq2cyku3scw3wbgolpmsutdgmvy4s7k4qx6ixisrqyif6rya?img-width=300&img-height=300&img-fit=cover&img-quality=80&img-onerror=redirect&img-fit=pad&img-format=webp"
        alt="BONEHEADZ"
        width="150"
        height="150"
      ></img>
      <img
        src="https://byzantion.mypinata.cloud/ipfs/bafybeifetknoql6toafbhfy5bsasl5cmbwxfhvjbpnhcw7d7efuqfnjh4a?img-width=850&img-height=850&img-fit=cover&img-quality=80&img-onerror=redirect&img-fit=pad&img-format=webp"
        alt="BONEHEADZMMCDETECTIVE"
        width="150"
        height="150"
      ></img>
      <img
        src="https://byzantion.mypinata.cloud/ipfs/bafybeigp23kc326f6ohkmqqyagurdx3qwwyxalo5ccjp7fi74qqzlgw6im?img-width=850&img-height=850&img-fit=cover&img-quality=80&img-onerror=redirect&img-fit=pad&img-format=webp"
        alt="BONEHEADZMMCPUP"
        width="150"
        height="150"
      ></img>
      <img
        src="https://byzantion.mypinata.cloud/ipfs/bafybeigkqvnqq2vb2wj4jceo2mw4xmsdwarbp7opdegiwdur4xqznutk4e"
        alt="BONEHEADZMASK"
        width="150"
        height="150"
      ></img>
      ...
      <a href="https://www.tradeport.xyz/near/collection/bnehedz-by-bonehedznear?tab=marketview">
        🔗---B💀NEHEDZ on Tradeport
      </a>
      <br></br>
      <hr />
      <h3>🫘---Beaning</h3>
      <i>Beans just beaning around on $NEAR.</i>
      <br></br>
      <img
        src="https://byzantion.mypinata.cloud/ipfs/bafybeic6tgnvxxt644gqhtv6xinyjax4halq3ilhlmany7kcl6ioy3osqq?img-width=900&img-height=900&img-fit=cover&img-quality=80&img-onerror=redirect&img-fit=pad&img-format=webp"
        alt="BEANINGLOGO"
        width="150"
        height="150"
      ></img>
      <img
        src="https://byzantion.mypinata.cloud/ipfs/bafybeibavngmgedkjnqngmqpsvrcjdlu3b22lk4sylel4yjiciubh7gkvy?img-width=850&img-height=850&img-fit=cover&img-quality=80&img-onerror=redirect&img-fit=pad&img-format=webp"
        alt="BEANINGMMC"
        width="150"
        height="150"
      ></img>
      <img
        src="https://byzantion.mypinata.cloud/ipfs/bafybeiagmmns6ecrjaw6cixho2hql4p45fxbjplhwgohassvmbaaa4cjle"
        alt="BEANINGLJ"
        width="150"
        height="150"
      ></img>
      <img
        src="https://byzantion.mypinata.cloud/ipfs/bafybeihbzmlkmvmuma4ocyicm37qlatgivgbpb2tummyddlgmxxb6vtn2m?img-width=850&img-height=850&img-fit=cover&img-quality=80&img-onerror=redirect&img-fit=pad&img-format=webp"
        alt="BEANINGAV"
        width="150"
        height="150"
      ></img>
