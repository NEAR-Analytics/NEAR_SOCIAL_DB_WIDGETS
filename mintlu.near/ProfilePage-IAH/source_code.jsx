...
const accountUrl = `#/mintlu.near/widget/ProfilePage-IAH?accountId=${accountId}`;
...
return (
  <Wrapper>
    ...
    <Main>
      <SidebarWrapper>
        <Widget
          src="mintlu.near/widget/ProfilePage.Sidebar-IAH"
          props={{
            accountId,
            profile,
          }}
      ...
      <Content>
        ...
        {state.selectedTab === "apps" && (
          <Widget
            src="mintlu.near/widget/ComponentCollection-IAH"
            props={{ accountId }}
          />
        )}
