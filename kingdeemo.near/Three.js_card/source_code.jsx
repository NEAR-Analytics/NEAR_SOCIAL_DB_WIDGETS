const accountId = props.accountId ?? "kingdeemo.near";
...
const CardComponent = () => {
  return (
    <div className="w-100">
      ...
      />
      Turn your image into a 3d card!
    </div>
  );
};
