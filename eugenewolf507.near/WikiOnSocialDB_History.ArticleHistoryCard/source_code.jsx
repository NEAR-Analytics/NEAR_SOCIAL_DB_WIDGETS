//props
//props.pathToCurrentArticle: string
//props.pathToPrevArticle: string
...
return (
  <div className="card border-primary">
    ...
    <Widget
      ...
      props={{
        pathToCurrentArticle: props.pathToCurrentArticle,
        pathToPrevArticle: props.pathToPrevArticle,
