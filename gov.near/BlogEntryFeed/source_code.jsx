...
const entryToWidget = (a) => (
  <div key={JSON.stringify(a)} style={{ minHeight: "200px" }}>
    <a
      ...
      href={`#/gov.near/widget/BlogEntry?accountId=${a.accountId}&blockHeight=${a.blockHeight}`}
    >
      <Widget src="gov.near/widget/BlogEntry" props={a} />
    </a>
  </div>
);
...
return (
  ...
  >
    {context.accountId ? (
      <a href="https://near.social/#/gov.near/widget/AddBlogEntry">
        Create a Blog Entry
      </a>
    ) : (
      ""
