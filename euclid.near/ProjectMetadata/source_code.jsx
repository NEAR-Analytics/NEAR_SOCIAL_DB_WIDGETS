...
const projectPath = `${accountId}/project/${projectName}`;
const blockHeight = props.blockHeight;
const metadata = props.metadata ?? Social.getr(`${projectPath}/metadata`);
const renderTag = props.renderTag;

const name = metadata.name ?? projectName;
...
const descriptionKey = `${projectPath}-description`.replaceAll(
  /[._\/-]/g,
  "--"
);
      ...
      <div className="col px-2">
        <div className="position-relative">
          ...
          <div className="text-truncate mb-1">
            <a className="stretched-link" href={`#/${projectPath}`}>
        ...
        <div className="card-text">
          ...
          <a
            href={`#/euclid.near/widget/ProjectSource?src=${projectPath}`}
            className="btn btn-sm btn-outline-secondary border-0"
            target="_blank"
          >
        ...
        <div>
          <small className="ps-1 text-nowrap text-muted ms-auto">
            ...
            <Widget
              ...
              props={{ keyPath: projectPath, now: props.metadata, blockHeight }}
            />
          </small>
        </div>
      </div>
