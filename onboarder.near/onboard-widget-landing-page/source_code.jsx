  ...
  <Theme>
    <div class="header">
      ...
      <div class="header-content-left">
        <div>
          <div>
            <h1>OnboardDAO?</h1>
            <h2>&#60;Web3 onboarding&#62;</h2>
          </div>
          <div>
            <a href="https://onboarddao.org/about/" target="_blank">
              <h3>Read Docs -&#62;</h3>
            </a>
          </div>
        </div>
      ...
      <div class="header-content-right">
        <div>
          ...
          <div>
            <a href="https://onboarddao.org" target="_blank">
              <h3>The Road to -&#62;</h3>
            </a>
          </div>
        </div>
    ...
    <div class="footer">
      <div className="text-center">
        <a href="https://onboarddao.org/telegram" target="_blank">
          Telegram
        </a>{" "}
        <span>|</span>{" "}
        <a href="https://twitter.com/onboard_dao" target="_blank">
          Twitter
        </a>
      </div>
    </div>
