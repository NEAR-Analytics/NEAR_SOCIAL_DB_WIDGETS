        ...
        >
          <Widget
            ...
            props={{
              ...
              className: allWidgetsClassNames.styles.itemsImage,
              thumbnail: false,
              fallbackUrl:
                "https://ipfs.near.social/ipfs/bafkreido7gsk4dlb63z3s5yirkkgrjs2nmyar5bxyet66chakt2h5jve6e",
              alt: "items image",
              style: allWidgetsInlineStyles.styles.itemsImage,
            }}
          />
        </div>
        <h3 style={allWidgetsInlineStyles.styles.itemsTitle}>Items!</h3>
      </div>
