...
const daoId = props.daoId ?? "creatives.sputnik-dao.near";
...
return (
  <Container>
    <Flex>
      ...
      <div className="mt-3">
        <Text style={{ maxWidth: "670px" }}>
          The Creatives DAO is an overarching body for all creative contributors
          in the NEAR ecosystem and beyond! With support via decentralized
          autonomous organizations, all creators have the freedom to express
          themselves and create impactful projects that promote decentralization
          and sustainability.
        </Text>
      </div>
    </Flex>
    ...
    <Widget src="hack.near/widget/creatives.apps" props={{ tab }} />
    <hr />
    <br />
    <Flex>
      <Text
