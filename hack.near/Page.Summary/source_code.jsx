...
const showEditButton =
  page !== undefined &&
  (!props.page || props.showEditButton) &&
  accountId &&
  accountId === context.accountId;

const name = page.name || "TBD";
const image = page.image;
const backgroundImage = page.backgroundImage;
const tags = Object.keys(page.tags ?? {});
...
return (
  <div className="bg-white shadow rounded overflow-hidden">
    <div className="px-4 pt-0 pb-5 bg-dark position-relative">
      ...
      <div
        className="page-picture d-inline-block"
