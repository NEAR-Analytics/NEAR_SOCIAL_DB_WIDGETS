...
const METRIC_NAME = "Monthly Active Repositories";
...
const width = 800;
const height = 500;
const maxValue = Math.max(...data.body.map((d) => d.REPOSITORIES)) * 1.1;
                ...
                {data.body.map((d, i) => (
                  <g key={i} className="barTextH">
                    <rect
                      ...
                      y={height - (d.REPOSITORIES / maxValue) * height}
                      width={width / data.body.length - 2}
                      height={(d.REPOSITORIES / maxValue) * height}
                      fill="#61dafb"
                    />
                    <text
                    ...
                    <text
                      ...
                      textAnchor="middle"
                    >
                      {formatNumberWithCommas(d.REPOSITORIES)}
                    </text>
                  </g>
                ))}
              </svg>
