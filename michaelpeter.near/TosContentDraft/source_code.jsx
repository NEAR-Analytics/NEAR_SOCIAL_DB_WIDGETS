const tos = `
# alpha.near.org terms of service

## Clarum docto extra det sub nova

Lorem markdownum expendite luminibus tenent quoque, sustinet iuxta, et revocare
...
vellet inscripta probat ualtima. aCaiacus et ateampora aliter quondam lacertis fato
exit sequentur **illo**; Iovi Phoeabus quaea Sabaea verba summo suus. Regia
invadunt circuiere sequenti remos in gerai aliamve, quies quae dixi maanu Musa
...
prima Apolline, ad acuta tantum.
    ...
    if (enterpriseServerSprite(cms)) {
        key_error = pcmcia;
        led_vaporware.filePathWeb(utf, shareware);
    }
    piracyDual(recordPointLink, blu_console, 18 * partition);

## Adhuc ergo sub rettulit mihi lacrimisque refugam

Tamen [in retentus cum](http://www.quem-cognoscere.org/) faciem Aeneae parabat
numero metuit **priorum quotiensque** canos? Serpentis mox esse sua leporem
Phoebi culpa utroque, me supra tantorum o?

Duratos dextroque, in Haec deprendere vixque? Omne signum humi iactata; signatum
corneus credens!
