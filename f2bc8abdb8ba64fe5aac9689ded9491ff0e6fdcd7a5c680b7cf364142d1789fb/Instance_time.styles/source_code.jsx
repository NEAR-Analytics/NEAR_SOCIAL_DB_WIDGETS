...
const allWidgetsClassNames = {
  instance_time: {
    ...
    decorativeDivInHeader: "w-100 d-flex flex-row justify-content-between align-items-center",
    bodyContainer: "align-items-center",
  },
  instance_time_card: {
      widgetGeneralContainer: "d-flex content-align-start justify-content-between",
      widgetHeaderContainer: "w-100 d-flex flex-row justify-content-between align-items-center",
      closeIcon: closeIcon,
