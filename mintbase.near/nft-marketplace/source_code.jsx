...
return data !== null ? (
  <>
    <h1>Current Mintbase Listings</h1>
    <p>
      Buying from this widget will redirect 1.25% of the sale if you change
      ?affiliateAccount=mynearaccount.near at the end of the URL.
    </p>
