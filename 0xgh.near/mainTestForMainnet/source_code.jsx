    ...
    <div className={`widget-wrapper`}>
      {state.address ? (
        state.selectedTab === "Borrow" ? (
          <Widget src={`0xgh.near/widget/openTroveTestForMainnet`} />
        ) : state.selectedTab === "Manage" ? (
          state.troveStatus === "1" ? (
            <Widget src={`0xgh.near/widget/troveManageTestForMainnet`} />
          ) : (
            <div className="open-trove-first">Open trove first</div>
          )
        ) : state.selectedTab === "Pay off" ? (
          state.troveStatus === "1" ? (
            <Widget src={`0xgh.near/widget/trovePayoffTestForMainnet`} />
          ) : (
            <div className="open-trove-first">Open trove first</div>
          )
        ) : (
