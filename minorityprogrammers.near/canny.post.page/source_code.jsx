...
const questionUrl = `minorityprogrammers.near/widget/edu.post.page?accountId=${accountId}&blockHeight=${blockHeight}`;
...
return (
  <div className="pt-2 pb-5">
    ...
    <Widget
      src="minorityprogrammers.near/widget/canny.post.details"
      props={{
        accountId,
        blockHeight,
        admins,
