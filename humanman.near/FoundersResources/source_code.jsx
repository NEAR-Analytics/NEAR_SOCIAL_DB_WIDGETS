...
const props = {
  ...
  growth: [
    ...
    },
    {
      ...
      link: "https://near.social/#/mob.near/widget/MyPage?accountId=readylayerone.near",
      description:
  ...
  technical: [
    ...
    {
      title: "Stats Gallery",
      link: "https://stats.gallery/",
      description:
        "Guides and tutorials from around the network! Quests. Get and complete quests to pump your account up!",
      img: "",
